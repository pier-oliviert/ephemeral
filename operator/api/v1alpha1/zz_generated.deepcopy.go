...
func (in BuildConditions) DeepCopyInto(out *BuildConditions) {
	{
		in := &in
		*out = make(BuildConditions, len(*in))
		for i := range *in {
...
func (in *ComponentSpec) DeepCopyInto(out *ComponentSpec) {
	*out = *in
	...
	if in.Networks != nil {
		...
		*out = make([]ComponentNetworkSpec, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
func (in WorkspaceConditions) DeepCopyInto(out *WorkspaceConditions) {
	{
		in := &in
		*out = make(WorkspaceConditions, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
func (in *WorkspaceStatus) DeepCopyInto(out *WorkspaceStatus) {
	*out = *in
	...
	if in.Services != nil {
		...
		*out = make(map[string]ServiceReference, len(*in))
		for key, val := range *in {
			(*out)[key] = val
		}
	}
